...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            vault_db::list_sourcecard_metadata_review_audit_events,
            vault_db::list_sourcecard_metadata_reviews_for_source_document,
            vault_db::list_intake_source_document_audit_events,
            vault_db::list_content_chunks_for_document,
            vault_db::list_knowledge_units_for_source_document,
            vault_db::list_metadata_correction_audit_events,
            vault_db::list_source_sections_for_document,
            ...
            vault_db::read_saved_source_document_root,
            vault_db::run_metadata_correction_apply_dry_run,
            vault_db::save_draft_artifact_candidate,
            vault_db::save_intake_source_document_candidates,
            vault_db::save_knowledge_unit,
            vault_db::save_knowledge_cards_for_source_card,
            vault_db::save_marketing_tags_for_source_card,
            vault_db::save_source_card_apa_reference_review,
            vault_db::save_source_card_candidate,
            vault_db::save_source_document_candidate,
            vault_db::save_source_section_content_chunk_candidates,
            vault_db::save_sourcecard_metadata_review,
            vault_db::list_suggested_metadata_corrections,
            vault_db::update_source_card_metadata,
            vault_db::update_suggested_metadata_correction_review_state,
